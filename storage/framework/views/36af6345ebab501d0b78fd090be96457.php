        ...
        <div class="row">
          <div class="col-md-12 col-sm-12  ">
            <div class="x_panel">
              ...
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="cashierLogin">
               <?php echo csrf_field(); ?> 
              ...
              <div class="item form-group">
                <div class="col-md-12 col-sm-12">
                  <center>
                    ...
                    <button type="submit"  class="btn" style="background-color: rgb(121,146,168);color: rgb(11, 52, 61);">Login as Cashier</button>
                    
                    
                    <a class="btn" style="background-color: rgb(22, 104, 122);color: rgb(192, 202, 211);" href="/"  >Login as Admin</a>
...
<?php /**PATH C:\Users\kalema\Documents\Pharmacy Management System\resources\views/cashier-login.blade.php ENDPATH**/ ?>